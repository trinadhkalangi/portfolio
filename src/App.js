        ...
        <main className="cf pa3 pa4-m pa5-l mw9 center">
          <div className="fr w-100">
            ...
            <p className="f4-l f4-m lh-title mt0 mb4 mb5-ns mr3">
              I'm a UX &amp; Interaction designer. Interned with <a className="purple link hover-purple" href="#0">Microsoft 🖥</a>,
              previously designed for <a className="orange link hover-orange" href="#0">Singapore Airlines ✈️.</a> Masters from IDC School of Design, IIT Bombay 🎓.
            </p>
          </div>
